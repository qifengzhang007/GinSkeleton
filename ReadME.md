...
-   4.<font color=#FF4500>本项目骨架从V1.4.00开始，要求go语言版本必须 >=1.15，才能稳定地使用gorm v2读写分离方案.</font>
...
#### V 1.6.0 2026-04-22（最新版本）
**更新**
- 1.更新依赖包至最新版本.  
- 2.修复由于go语言升级导致部分单元测试执行报错的bug.  
- 3.增加了grpc服务端示例代码以及相关单元测试.  
