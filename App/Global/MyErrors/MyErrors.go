...
const (
	...
	Errors_Db_ExecuteForMultiple_Fail   string = "批量执行的sql语句执行失败"
	Errors_Db_Transaction_Begin_Fail    string = "sql事务开启（begin）失败"
	Errors_Db_Transaction_Commit_Fail   string = "sql事务提交（commit）失败"
	Errors_Db_Transaction_Rollback_Fail string = "sql事务回滚（rollback）失败"
