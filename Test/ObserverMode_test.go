...
import (
	"GinSkeleton/App/Service/WeakRelaService"
	"fmt"
	"testing"
)
...
func TestObserverMode(t *testing.T) {
	...
	WeakRelaService.SubjectHub1.BroadCast("DD2020060600600001", "笔记本电脑", "备注：重量1.5Kg")
	fmt.Println("==================")
	WeakRelaService.SubjectHub1.BroadCast("DD2020060600600002", "手机X007", "备注：一部")
